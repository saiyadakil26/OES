...
<div id="mycon">
 ...
 <img src="avatar.jpg"alt="LOGO OF AAU" width=63 height=63>
  ...
  <p class="pa"><a href="trs.php"><img src="refesh.png"alt="LOGO OF AAU" width=15 height=15>  REFRESH</a></p>
...
<p  style="color:yellow;"><b>YOUR CURRENT LOCATION || </b><a href="lgout.php">HOME</a><a href="tech.php"> >> DASHBORD </a><a href="trs.php">>>EXAME'RESULT</a></p></td></tr></table>
...
<table width=100% height=73%><tr>
			<th colspan=2 align=center><input type=button name=s1 class="block" value="ABSENT STUDENT IN EXAME " onClick="document.location.href='absent.php'" style="background-color:skyblue;"></th>
		</tr>	

	<tr><td><?php
echo "<caption><b><font color=blue><h3>IT'S RESULT'S OF EXAME </h3></font></b></caption>";
?></td>
	<td>
...
?>
	...
	<td bgcolor="darkslategray" align=center><font color=white><?php echo $rw['sname'] ;?></font></td>
		</tr><?php if($rw['mark']==1000000000){?>
<tr>
			<th colspan=2 align=center><input type="button" class="block" value="PAPER CHECK" onClick="document.location.href='trr.php?no=<?php echo $rw["sid"];?>&&ne=<?php echo $rw["sname"];?>&&b=1'"></th>
		</tr><?php }else {?><tr>
		<td bgcolor="gold"><b>GET MARK:- </b></td>
	<td bgcolor="darkslategray" align=center><font color=white><?php echo $rw['mark'] ;?></font></td><?php }?>
		</tr>	
