...
<div id="mycon">
 ...
 <img src="avatar.jpg"alt="LOGO OF AAU" width=63 height=63>
  ...
  <p class="pa"><a href="treport.php"><img src="refesh.png"alt="LOGO OF AAU" width=15 height=15>  REFRESH</a></p>
...
<p  style="color:yellow;"><b>YOUR CURRENT LOCATION || </b><a href="lgout.php">HOME</a><a href="tech.php"> >> DASHBORD </a><a href="treport.php">>>EXAME'S REPORT</a></p></td></tr></table>
...
<?php
	...
	$e=$_SESSION['eid'];
	$en=$_SESSION['en'];
	$q="select * from exame where cid=$i order by id DESC ";
...
?>
	...
	<td bgcolor="darkslategray" colspan="3" align=center><font color=white><?php echo $rw['cid'] ;?></font></td>
		</tr><tr>
		<td bgcolor="gold"><b>USER NAME:- </b></td>
	<td bgcolor="darkslategray" align=center><font color=white><?php echo $n;?></font></td>
		</tr><tr>
	...
	<td bgcolor="darkslategray" align=center><font color=white><?php echo $rw['ename'] ;?></font></td>
		</tr><tr>
		<td bgcolor="gold"><b>SECRET KEY:- </b></td>
	<td bgcolor="darkslategray" align=center><font color=white><?php echo $rw['skey'] ;?></font></td></tr><tr>
		<td bgcolor="gold"><b>EXAME TYPE:- </b></td>
	<td bgcolor="darkslategray" align=center><font color=white><?php echo $rw['etype'] ;?></font></td></tr><tr>
<td bgcolor="gold"><b>EXAME DURATION:- </b></td>
	<td bgcolor="darkslategray" align=center><font color=white><?php echo $rw['edr'] ;?></font></td></tr>		
</table><?php } ?>
<tr>
