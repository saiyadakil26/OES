...
<div id="mycon">
 ...
 <img src="avatar.jpg"alt="LOGO OF AAU" width=63 height=63>
  ...
  <p class="pa"><a href="stud.php"><img src="refesh.png"alt="LOGO OF AAU" width=15 height=15>  REFRESH</a></p>
...
?>
		...
		<td bgcolor="dimgray"><div class="example">
      			...
      			<div class="content">
        		<div class="text"><a href="gexame.php" style="color:gold;">CURRENT EXAM</a></div>
      			</div>
    		</div>
		</td>
				<td bgcolor="darkslategray">
		<div class="example">
      			...
      			<div class="content">
        		<div class="text"><a href="lastex.php" style="color:gold;">LAST EXAM</a></div>
      			</div>
    		</div>
		</td>
		<td bgcolor="dimgray"><div class="example">
      			...
      			<div class="content">
        		<div class="text"><a href="sreport.php" style="color:gold;">REPORT</a></div>
      			</div>
    		</div>
		</td></tr></table>
</td></tr></table>
