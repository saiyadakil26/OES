...
<div id="mycon">
 ...
 <img src="avatar.jpg"alt="LOGO OF AAU" width=63 height=63>
  ...
  <p class="pa"><a href="rou.php?no=<?php echo $i;?>&&ne=<?php echo $n;?>"><img src="refesh.png"alt="LOGO OF AAU" width=15 height=15>  REFRESH</a></p>
...
<p  style="color:yellow;"><b>YOUR CURRENT LOCATION || </b><a href="lgout.php">HOME</a><a href="admi.php"> >> DASHBORD </a><a href="rou.php?no=<?php echo $i;?>&&ne=<?php echo $n;?>">>>USER'S REPORT</a></p></td></tr></table>
<form method=post action=usr.php>
<?php
	$e=$_SESSION['eid'];
	$en=$_SESSION['en'];
	$q="select * from $i$n  order by id DESC ";
...
<table width=100% height=73%>
	<tr><td><?php
echo "<caption><b><font color=blue><h3>IT'S YOUR USER'S RESULTS </h3></font></b></caption>";
?></td>
	<td>
...
?>
	...
	<td bgcolor="darkslategray" colspan="3" align=center><font color=white><?php echo $rw['eid'];?></font></td>
		</tr><tr>
