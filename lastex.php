...
<div id="mycon">
 ...
 <img src="avatar.jpg"alt="LOGO OF AAU" width=63 height=63>
  ...
  <p class="pa"><a href="lastex.php"><img src="refesh.png"alt="LOGO OF AAU" width=15 height=15>  REFRESH</a></p>
...
<p  style="color:yellow;"><b>YOUR CURRENT LOCATION || </b><a href="lgout.php">HOME</a><a href="stud.php"> >> DASHBORD </a><a href="lastex.php">>>LAST EXAME</a></p></td></tr></table>
...
<?php
	...
	$e=$_SESSION['eid'];
	$en=$_SESSION['en'];
	$q="select * from $i$n  order by id DESC LIMIT 1";
...
<?php
echo "<caption><b><font color=blue><h3>IT'S YOUR LAST EXAME RESULT </h3></font></b></caption>";
