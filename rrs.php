...
<div id="mycon">
 ...
 <img src="avatar.jpg"alt="LOGO OF AAU" width=63 height=63>
  ...
  <p class="pa"><a href="rrs.php?no=<?php echo $u; ?>&&ne=<?php echo $ue; ?>"><img src="refesh.png"alt="LOGO OF AAU" width=15 height=15>  REFRESH</a></p>
...
<p  style="color:yellow;"><b>YOUR CURRENT LOCATION || </b><a href="lgout.php">HOME</a><a href="tech.php"> >> DASHBORD </a><a href="rrs.php?no=<?php echo $u; ?>&&ne=<?php echo $ue; ?>">>>EXAME</a></p></td></tr></table>
<form method=post action=mrs.php>
<?php
	if (isset($_GET["no"]))
	{
	$u=$_GET["no"];
...
<table width=100% height=73%>
	<tr><td><?php
echo "<caption><b><font color=blue><h3>IT'S A RESELT OF $ue </h3></font></b></caption>";
?></td>
	<td>
...
?>
	...
	<td bgcolor="gold"><b>GIVEN ANSWER:- </b></td>
		</tr><tr>
	<td bgcolor="darkslategray" align=center><font color=white><?php echo $rw['que'] ;?></font></td>
	<td bgcolor="darkslategray"  align=center><font color=white><?php echo $rw['ans'];?></font></td>
	<td bgcolor="darkslategray" align=center><font color=white><?php echo $ro['answer'] ;?></font></td>
		</tr>
