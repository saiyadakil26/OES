...
<div id="mycon">
 ...
 <img src="avatar.jpg"alt="LOGO OF AAU" width=63 height=63>
  ...
  <p class="pa"><a href="admi.php"><img src="refesh.png"alt="LOGO OF AAU" width=15 height=15>  REFRESH</a></p>
...
<p  style="color:yellow;"><b>YOUR CURRENT LOCATION || </b><a href="lgout.php">HOME</a><a href="admi.php"> >> DASHBORD </a></p></td></tr></table>
<form method=post action=adduser.php>

<table width=100% height=73%>
	<tr>
	<td>
	<table border=5 bgcolor=lightgray cellpadding=10 cellspacing=3 align=center BORDERCOLOR=rosybrown width=auto hight=auto>
<?php
...
?>
		...
		<div class="example">
      			<img src="profile.png" alt="profile" width=250 height=250></a>
      			<div class="content">
        		<div class="text"><a href="usr.php" style="color:gold;">USERS IN SYSTEM</a> </div>
      			</div>
    		</div>
		</td>
		<td bgcolor="dimgray"><div class="example">
      			<img src="curentexam.png" alt="profile" width=250 height=250>
      			<div class="content">
        		<div class="text"><a href="tke.php" style="color:gold;">TAKEN EXAM'S</a></div>
      			</div>
    		</div>
		</td>
		</tr></table>
