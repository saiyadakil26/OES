...
<div id="mycon">
 ...
 <img src="avatar.jpg"alt="LOGO OF AAU" width=63 height=63>
  ...
  <p class="pa"><a href="rot.php?no=<?php echo $i;?>&&ne=<?php echo $n;?>"><img src="refesh.png"alt="LOGO OF AAU" width=15 height=15>  REFRESH</a></p>
...
<p  style="color:yellow;"><b>YOUR CURRENT LOCATION || </b><a href="lgout.php">HOME</a><a href="admi.php"> >> DASHBORD </a><a href="rot.php?no=<?php echo $i;?>&&ne=<?php echo $n;?>">>>EXAME'S REPORT</a></p></td></tr></table>
...
?>
	...
	<td bgcolor="darkslategray" align=center><font color=white><?php echo $rw['etype'] ;?></font></td></tr>		
</table><?php } ?>
<tr>
