...
<div id="mycon">
 ...
 <img src="avatar.jpg"alt="LOGO OF AAU" width=63 height=63>
  ...
  <p class="pa"><a href="mrs.php"><img src="refesh.png"alt="LOGO OF AAU" width=15 height=15>  REFRESH</a></p>
...
<p  style="color:yellow;"><b>YOUR CURRENT LOCATION || </b><a href="lgout.php">HOME</a><a href="tech.php"> >> DASHBORD </a><a href="mrs.php">>>EXAME'RESULT</a></p></td></tr></table>
...
<tr>
			<th colspan=2 align=center><input type="button" class="block" value="RESULT" onClick="document.location.href='rrs.php?no=<?php echo $rw["sid"];?>&&ne=<?php echo $rw["sname"];?>'"></th>
		</tr>	
