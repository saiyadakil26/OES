...
<div id="mycon">
 ...
 <img src="avatar.jpg"alt="LOGO OF AAU" width=63 height=63>
  ...
  <p class="pa"><a href="absent.php"><img src="refesh.png"alt="LOGO OF AAU" width=15 height=15>  REFRESH</a></p>
...
<p  style="color:yellow;"><b>YOUR CURRENT LOCATION || </b><a href="lgout.php">HOME</a><a href="tech.php"> >> DASHBORD </a><a href="absent.php">>>EXAME'S REPORT</a></p></td></tr></table>
...
<?php
	...
	$en=$_SESSION['en'];
	//echo"$en";
	$q="select * from user where utype='STUDENT' order by id DESC ";
	$result=mysqli_query($con,$q);
	?>

<table width=100% height=73%>
	<tr><td><?php
echo "<caption><b><font color=blue><h3>IT'S YOUR REPORT </h3></font></b></caption>";
?></td>
	<td>
<?php	while($rw = mysqli_fetch_assoc($result))
{        $ghl=$rw['id'] ;
	$vb="result";
	$qbl="select * from $e$en$vb where sid='$ghl'";
	//echo"$qbl";
	$resl=mysqli_query($con,$qbl);
...
?>
	...
	<td bgcolor="darkslategray" colspan="3" align=center><font color=white><?php echo $rw['id'] ;?></font></td>
		</tr><tr>
		<td bgcolor="gold"><b>USER NAME:- </b></td>
	<td bgcolor="darkslategray" align=center><font color=white><?php echo $rw['uname'];?></font></td>
		</tr><tr>
	<td bgcolor="gold"><b>USER MOBILE NUMBER:- </b></td>
	<td bgcolor="darkslategray" colspan="3" align=center><font color=white><?php echo $rw['mono'];?></font></td>
		</tr><tr>
		<td bgcolor="gold"><b>USER E-MAIL ADDRESS:- </b></td>
	<td bgcolor="darkslategray" align=center><font color=white><?php echo $rw['email'] ;?></font></td>
		</tr><tr>
		<td bgcolor="gold"><b>USER REG.NO:- </b></td>
	<td bgcolor="darkslategray" align=center><font color=white><?php echo $rw['regno'] ;?></font></td></tr>		
</table><?php } } ?>
<tr>
